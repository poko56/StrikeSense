> [!CAUTION]
> **สถานะฟีเจอร์ Motion Capture:** ปัจจุบันระบบ Motion Capture (การใช้กล้องประมวลผล MediaPipe Pose 3D) **ยังไม่สามารถใช้งานได้** (ฟีเจอร์นี้อยู่ระหว่างการพัฒนาและพักไว้) เอกสารฉบับนี้จัดทำไว้สำหรับการอ้างอิงข้อกำหนดทางเทคนิคและสถาปัตยกรรมเมื่อฟีเจอร์เปิดใช้งานในอนาคต
